...
--Autostart Apps
-- awful.util.spawn_with_shell("cbatticon --icon-type symbolic") -- Battery Icon
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift" }, "a", function () awful.util.spawn("pavucontrol") end),
...
awful.rules.rules = {
    ...
    { rule = { name = "*.SMPlayer.*" }, properties = { floating = false } },    
    { rule = { name = "smplayer" }, properties = { floating = false } },    
    { rule = { name = "SMPlayer" }, properties = { floating = false } }, 
    { rule = { name = "MPlayer" }, properties = { floating = false } }, 
    { rule = { class = "smplayer" },
